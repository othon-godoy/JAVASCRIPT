//Utilizando Arrays Básicos em JavaScript
listaCursos = Array();
listaCursos[0] = "PHP";
listaCursos[1] = "MySQL";
listaCursos[2] = "HTML, CSS e JavaScript";
...
listaCursos1[0] = "PHP";
listaCursos1[1] = "TSQL";
listaCursos1[2] = "HTML, CSS e JavaScript";

console.log(listaCursos1);

listaCursos2 = Array('PHP', 'SQL Server', 'HTML, CSS e JavaScript');
...
//Utilizando Arrays Multidimensionais em JavaScript
var listaCompras = Array();
listaCompras['programacao'] = Array('C', 'C++', 'C#', 'Java', 'Python', 'PHP');

listaCompras['banco_de_dados'] = Array('MySQL', 'SQL Server', 'TSQL', 'PL/SQL');

listaCompras['front_end'] = Array('HTML', 'CSS', 'JavaScript');

console.log(listaCompras);
console.log(listaCompras['programacao']);
